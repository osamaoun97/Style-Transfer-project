...
# Set the parent directory for file paths
parent = "deployment"

# Set the output path for the generated image
output_path = "/assets/trymodel/output.jpg"

# Set the file paths for the style and content images
...
# Callback to update the source of the three images based on the selected image from the dropdown
@app.callback(
...
def update_images(number):
    image_src1 = f'/assets/content_images/content_image{number}.jpg'  # Source for the first image
    image_src2 = f'/assets/style_images/style_image{number}.jpg'  # Source for the second image
    image_src3 = f'/assets/output_images/output_image{number}.jpg'  # Source for the third image
...
# Callback to generate the image
